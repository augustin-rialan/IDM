...
public class QcmParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, QcmGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getReponseAccess().getGroup_3(), "rule__Reponse__Group_3__0");
			...
			builder.put(grammarAccess.getReponseAccess().getValueAssignment_3_1(), "rule__Reponse__ValueAssignment_3_1");
		}
	}
